        ...
        if (!res && !member.roles.exists("id", config.muted)) {
            ...
            member
                ...
                .then(() => {
                    ...
                    db.bgsave();
                    msg.client.guilds
                        .get("457980242317934613")
                        .channels.get("457983529578528789")
                        .send({ embed })
                        .catch(console.error);
                    channel.send({ embed }).then(() => {
                        member.user
                            .send(`You have been unmuted by ${msg.author.tag}`)
                            .catch(console.error);
                    });
                })
                .catch(console.error);
