...
module.exports = class SayCommand extends Command {
    constructor(client) {
        super(client, {
            ...
            memberName: "log",
            description:
                "Toggles logging in the channel the command was executed.",
            examples: ["!log purge"],
            args: [
                {
                    key: "string",
    ...
    async run(msg, { string }) {
        ...
        if (string === "purge") {
            ...
            if (!res) {
                ...
                return msg
                    .reply(
                        `Successfully disabled purge logging in ${msg.channel}`
                    )
                    .then((e) => e.delete(3000));
            }
            db.del(`${msg.channel.id}purge`);
            return msg
                .reply(`Successfully enabled purge logging in ${msg.channel}`)
                .then((e) => e.delete(3000));
            ...
            if (!res) {
                ...
                return msg
                    .reply(`Successfully disabled logging in ${msg.channel}`)
                    .then((e) => e.delete(3000));
            }
            db.del(`${msg.channel.id}logging`);
            return msg
                .reply(`Successfully enabled logging in ${msg.channel}`)
                .then((e) => e.delete(3000));
        } else
            return msg
                .reply(`Invalid logging type: ${string}`)
                .then((e) => e.delete(3000));
    }
};
