...
module.exports = class SayCommand extends Command {
    constructor(client) {
        super(client, {
            ...
            memberName: "report",
            description:
                "Choose when you want to be pinged in reports channel.",
            guildOnly: true,
            examples: ["!report"]
        });
    }
    ...
    run(message) {
        ...
        const embed = new Discord.RichEmbed()
            .setTitle(
                "Hello! You can choose below when you want to be pinged in the reports channel!"
            )
            .addField(
                "1.",
                `If you don't want to be pinged in the reports channel react with 1️⃣`
            )
            .addField(
                "2.",
                `If you want to be pinged when you are online react with 2️⃣`
            )
